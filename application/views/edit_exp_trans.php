                ...
                <form class="form-horizontal">
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="col-sm-4 control-label" style="text-align:right;">اسم المستقبل : </label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="receipent_name" id="receipent_name">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <tbody>
                			...
                			foreach($query as $q){
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <a style="margin-left: 10px;" href="Admin/getExpTransEdit/<?php echo $q->id;?>"><span class="glyphicon glyphicon-edit"></span></a>
                                        <a href="Admin/deleteExpTrans/<?php echo $q->id;?>" class="ConfirmDelete"><span class="glyphicon glyphicon-remove"></span></a>
                                    </th>
                                </tr>
                                <?php
	                			}
...
<script>
    ...
    $('#customer_name,#receipent_name,#country,#from_date,#to_date,#from_money,#to_money').keypress(function(e) {
        if (e.which == 13) {
            $('#search').click();
        }
    });
    ...
    $('#search').click(function() {
        if (checkDateRange() && checkMoneyRange()) {
            ...
            $.ajax({
                type: "GET",
                url: "Transaction/ExpSearch",
                dataType: 'json',
                data: {
                    "customer_name": $('#customer_name').val(),
                    "receipent_name": $('#receipent_name').val(),
                    "country": $('#country').val(),
                ...
                success: function(response) {
                    ...
                    $.each(response, function(index, value) {
                        table.rows.add([{
                            ...
                            1: value.recipient_name_ar,
                            2: value.recipient_country,
                            3: value.created_at,
                            4: value.value + ' ' + value.currency_name,
                            5: '<a style="margin-left: 10px;" href="Admin/getExpTransEdit/' + value.id + '">' +
                                '<span class="glyphicon glyphicon-edit"></span>' +
                                '</a>' +
                                '<a href="Admin/deleteExpTrans/' + value.id + '" class="ConfirmDelete">' +
